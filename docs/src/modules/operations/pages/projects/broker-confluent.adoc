...
. Log in to https://confluent.cloud/[Confluent Cloud, window="new"] and select the cluster Akka should connect to. Create a new cluster if you do not have one already.

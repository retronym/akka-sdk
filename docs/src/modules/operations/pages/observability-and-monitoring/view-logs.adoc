...
This way, the trace ID that is passed through your components will be added to your logs. For more information on tracing, click xref:operations:observability-and-monitoring/traces.adoc[here].

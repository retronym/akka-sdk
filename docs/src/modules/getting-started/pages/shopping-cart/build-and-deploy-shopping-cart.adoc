...
You should be intentional about when you query views versus when you query entity state. Views are _eventually_ consistent while entities are _strongly_ consistent. You do not have to worry about views yet, though, as there are none in this quickstart.
...
. Send some requests using `curl`. Add some T-shirts to a shopping cart:
+
[source, command line]
----
